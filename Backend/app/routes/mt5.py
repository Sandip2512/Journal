...
async def connect_mt5(credentials: MT5CredentialsCreate, db: Session = Depends(get_db)):
    """
...
async def disconnect_mt5(user_id: str, db: Session = Depends(get_db)):  # ✅ CHANGED to str
    """
...
async def get_account_info(user_id: str, db: Session = Depends(get_db)):  # ✅ CHANGED to str
    """
